	...
	<div class="row-fluid center">
		...
		<div class="span12">
			...
			<div class="login-box center">
				...
				<p><span>Enter your new password</span><br>
				
				<form action="#">
				
					<input class="input-xlarge" type="text" placeholder="New Password">
					
					<div class="clear">&nbsp;</div>
					
					<input class="input-xlarge" type="text" placeholder=" Confirm New Password">
					
					<div class="clear">&nbsp;</div>
										
					<input type="submit" value="Submit" class="btn login-box-submit">
